...
- You can see my script from here:[SQLi_lab11_admin_password.py](https://github.com/Sec0gh/python-scripts/blob/main/Blind%20SQLi%20scripts/SQLi_lab11_admin_password.py)
- To run the script:
```
...
- You can do that by using an intruder in the burp suite but it will take a long time to finish.
- We can write a python script to extract the password automatically and quickly.
- You can see my script from here:[SQLi_lab12_admin_password.py](https://github.com/Sec0gh/python-scripts/blob/main/Blind%20SQLi%20scripts/SQLi_lab12_admin_password.py)
- To run the script:
```
